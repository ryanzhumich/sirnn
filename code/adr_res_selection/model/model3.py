...
class InterleaveModelCross(Model):

    def __init__(self, argv, max_n_agents, n_vocab, init_emb):
        super(InterleaveModelCross, self).__init__(argv, max_n_agents, n_vocab, init_emb)
    ...
    def compile(self, c, r, a, b, y_r, y_a, n_agents):
        ...
        p_a, p_r = self.output_layer(a_res, A_adr, z, h_r, y_r, y_a, n_agents, batch)
    ...
    def output_layer(self, a_res, A_adr, z, h_r, y_r, y_a, n_agents, batch):
        # y_a: 1D: batch, 2D: max_n_agents-1

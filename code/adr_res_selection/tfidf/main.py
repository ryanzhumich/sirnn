...
if __name__ == '__main__':
    ...
    # Addreseee Selection Rule
    parser.add_argument('--rule', choices=['recent','recentdirect'], default='recent', help='')
    parser.add_argument('--bins', choices=['document','context','distance'], default='document', help='Bins during testing')

    parser.add_argument('--output', default=None, help='output results or not')
